          ...
          {memberships.map((plan, index) => (
            ...
            >
              ...
              <div className="membershipIdealFor">
                <span>Ideal for</span>
                <p>
                  {plan.name === "Train" && "Clients who want structured weekly coaching and clear progression."}
                  {plan.name === "Recover" && "Clients who want strength coaching with dedicated recovery support."}
                  {plan.name === "Perform" && "Clients who want maximum contact, accountability and coaching support."}
                </p>
              </div>
