...
const services = [
  ...
  ["03", "Online coaching", "Individual programming, form feedback and accountability wherever you choose to train."],
  ["04", "Sports massage", "Focused recovery support to reduce tension, improve movement and maintain consistency."],
];
    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="heroContent">
          ...
          <p className="heroText">
            Premium evidence-led coaching for adults aged 30+ who want to build strength,
            move with confidence and remain capable for the long term.
          </p>
      ...
      <section className="section servicesSection" id="services">
        <div className="sectionIntro centered">
          ...
          <h2>One coaching standard. Four ways to access it.</h2>
        </div>
      ...
      <section className="section membershipsSection" id="memberships">
        ...
        <div className="oneOffBar">
          <div><span>1-hour PT session</span><strong>£55</strong></div>
          <div><span>30-minute massage</span><strong>£35</strong></div>
          <div><span>1-hour massage</span><strong>£60</strong></div>
        </div>
      </section>
      ...
      <section className="section studioSection" id="studio">
        <div className="studioCopy">
          ...
          <p>
            An appointment-only environment designed for purposeful training,
      ...
      <section className="section contactSection" id="contact">
        <div className="contactCopy">
          ...
          <div className="contactDetails">
            <span>Luton and surrounding areas</span>
            <span>Appointment-only coaching</span>
          </div>
        </div>
